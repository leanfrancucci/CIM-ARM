#ifndef  JUSER_LOGIN_FORM_H
#define  JUSER_LOGIN_FORM_H

#define  JUSER_LOGIN_FORM id
 ...
 *
 */
@interface  JUserLoginForm: JCustomForm
{
  USER			myUser;
  ...
  char myPassword[10];
  JFORM processForm;
  JFORM myDallasKeyForm;
  COLLECTION myDallasKeys;
  int forcePasswKey;
  OMUTEX myMutex;
