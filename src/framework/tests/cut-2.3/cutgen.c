 ...
 *
 * $Log: cutgen.c,v $
 * Revision 1.4  2009-01-15 16:40:13  yerfino
 * *** empty log message ***
 *
 * Revision 1.3  2007/06/15 16:07:12  yerfino
 * *** empty log message ***
 *
 * Revision 1.2  2007/05/30 13:08:14  yerfino
 * *** empty log message ***
 *
...
char * libCUT[] =
{
   ...
   "{",
   "  doLog( \"\033[31m%s(%d): %s\033[00m\", filename, lineNumber, string );",
   "  fflush( stdout );",
   "}",
   "",
   "static void print_integer_as_expected( int i )",
   "{",
   "  doLog( \"(signed) %d (unsigned) %u (hex) 0x%08lX\", i, i, i );",
   "}",
   "",
