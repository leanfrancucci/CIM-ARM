...
/*  { "Message"					      REQUEST							      ACTION 			JOBABLE }*/
	...
	,{"GetAcceptorsByCashTable", 					GET_ACCEPTORS_BY_CASH_TABLE_REQ,							NO_REQ_OP,		 0}

	,{"SetCashReference", 							SET_CASH_REFERENCE_REQ,		  	SETTINGS_REQ_OP,		 0}
	,{"GetCashReferences", 							GET_CASH_REFERENCES_REQ,				LIST_REQ_OP,		 0}
	,{"AddCashReference", 							SET_CASH_REFERENCE_REQ,				ADD_REQ_OP,		 0}
	,{"RemoveCashReference",						SET_CASH_REFERENCE_REQ,				REMOVE_REQ_OP,	 1}
	,{"GetCashReference",						    GET_CASH_REFERENCE_REQ,				NO_REQ_OP,	 0}
  ...
  ,{"GetDoorsByUserTable",        GET_DOORS_BY_USER_TABLE_REQ,  NO_REQ_OP,       0}
